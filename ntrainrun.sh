...
outdir=/u/home/b/bronsonj/project-sriram/summaryRHE/300k/split_10k/sumrheouts/ntrains/sumsout_${h2}_test${pol}${pc}_${tsize}_${n}
...
do
    python3 ${src}/sumrhe.py --pheno ${phen}/sim_${size}_${i}.sumstat \
                            --all-snps \
                            --trace ${demo}/trace_sum_241k_${n}.tr \
                            --out ${outdir}/sim_${size}_${i} 
    #> /dev/null
done
                  
                            #--rhe ${demo}/rhe_trace_output_241k \
                            #--save-trace ${demo}/trace_sum_241k_${n} \
